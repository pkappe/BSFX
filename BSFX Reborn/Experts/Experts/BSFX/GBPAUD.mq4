...
//|            for the Great Britain Pound/Australian Dollar         |
//+------------------------------------------------------------------+
   ...
   if(Symbol()=="GBPAUD" && justTraded==false)
     {
      ...
      if(gbpaudMove>=Move && spread<=MaxSpread && justTraded==false)
        {
      ...
      if(gbpaudMove<=(Move*-1) && spread<MaxSpread && justTraded==false)
        {
         double shortStop=gbpaudAsk+StopLoss;
         double shortGoal=Goal-gbpaudAsk;
