   ...
   if(Symbol()=="AUDCHF" && justTraded==false)
     {
      ...
      if(audchfMove>=Move && spread<=MaxSpread && justTraded==false)
        {
      ...
      if(audchfMove<=(Move*-1) && spread<MaxSpread && justTraded==false)
        {
         double shortStop=audchfAsk+StopLoss;
         double shortGoal=Goal-audchfAsk;
