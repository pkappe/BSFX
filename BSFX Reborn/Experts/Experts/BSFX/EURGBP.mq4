...
//|                 for the Euro/Great Britain Pound                 |
//+------------------------------------------------------------------+
   ...
   if(Symbol()=="EURGBP" && justTraded==false)
     {
      ...
      if(eurgbpMove>=Move && spread<=MaxSpread && justTraded==false)
        {
      ...
      if(eurgbpMove<=(Move*-1) && spread<MaxSpread && justTraded==false)
        {
         double shortStop=eurgbpAsk+StopLoss;
         double shortGoal=Goal-eurgbpAsk;
