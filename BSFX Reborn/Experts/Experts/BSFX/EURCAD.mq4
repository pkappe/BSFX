   ...
   if(Symbol()=="EURCAD" && justTraded==false)
     {
      ...
      if(eurcadMove>=Move && spread<=MaxSpread && justTraded==false)
        {
      ...
      if(eurcadMove<=(Move*-1) && spread<MaxSpread && justTraded==false)
        {
         double shortStop=eurcadAsk+StopLoss;
         double shortGoal=Goal-eurcadAsk;
