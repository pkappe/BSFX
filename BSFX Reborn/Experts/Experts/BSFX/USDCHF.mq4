...
//|              for the United States Dollar/Swiss Franc            |
//+------------------------------------------------------------------+
   ...
   if(Symbol()=="USDCHF" && justTraded==false)
     {
      ...
      if(usdchfMove>=Move && spread<=MaxSpread && justTraded==false)
        {
      ...
      if(usdchfMove<=(Move*-1) && spread<MaxSpread && justTraded==false)
        {
         double shortStop=usdchfAsk+StopLoss;
         double shortGoal=Goal-usdchfAsk;
