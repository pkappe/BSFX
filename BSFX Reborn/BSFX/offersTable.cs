...
namespace BSFX
{
	...
	public partial class BSFX : Form
	{
		...
		private void offersTable_RowChanged(object sender, RowEventArgs e)
		{
			...
			double fiftyMoveLong = 0.005;
			double fiftyMoveShort = -0.005;
			double hundredMoveLong = 0.01;
			double hundredMoveShort = -0.01;
			double goal = 0.003;
					...
					if (offerTableRow.Instrument == "AUD/CAD")
					{
						...
						if (audcadPast != 0)
						{
							...
							if (audcadMove > 0)
							{
								...
								if (moveCalc > hundredMoveLong && audcadJustTraded == false)
								{
									sOfferID = "16";
									iAmount = 1000;
									sBuySell = "B";
							...
							else if (audcadMove < 0 && audcadJustTraded == false)
							{
								audcadMoveBox.BackColor = System.Drawing.Color.Red;
								this.Invoke(new MethodInvoker(delegate { audcadMoveBox.Text = "(" + move + ")"; }));
								if (moveCalc < hundredMoveShort)
								{
									sOfferID = "16";
									iAmount = 1000;
									sBuySell = "S";
					...
					if (offerTableRow.Instrument == "AUD/JPY")
					{
						...
						if (audjpyPast != 0)
						{
							...
							if (audjpyMove > 0)
							{
								...
								if (moveCalc > fiftyMoveLong && audjpyJustTraded == false)
								{
									sOfferID = "17";
									iAmount = 1000;
									sBuySell = "B";
							...
							else if (audjpyMove < 0)
							{
								...
								this.Invoke(new MethodInvoker(delegate { audjpyMoveBox.Text = "(" + move + ")"; }));
								if (moveCalc < fiftyMoveShort && audjpyJustTraded == false)
								{
									sOfferID = "17";
									iAmount = 1000;
									sBuySell = "S";
					...
					if (offerTableRow.Instrument == "AUD/USD")
					{
						...
						if (audusdPast != 0)
						{
							...
							if (audusdMove > 0)
							{
								...
								if (moveCalc > hundredMoveLong && audusdJustTraded == false)
								{
									sOfferID = "6";
									iAmount = 1000;
									sBuySell = "B";
							...
							else if (audusdMove < 0 && audusdJustTraded == false)
							{
								...
								this.Invoke(new MethodInvoker(delegate { audusdMoveBox.Text = "(" + move + ")"; }));
								if (moveCalc < hundredMoveShort && audusdJustTraded == false)
								{
									sOfferID = "6";
									iAmount = 1000;
									sBuySell = "S";
					...
					if (offerTableRow.Instrument == "CAD/JPY")
					{
						...
						if (cadjpyPast != 0)
						{
							...
							if (cadjpyMove > 0)
							{
								...
								if (moveCalc > hundredMoveLong && cadjpyJustTraded == false)
								{
									sOfferID = "18";
									iAmount = 1000;
									sBuySell = "B";
							...
							else if (cadjpyMove < 0)
							{
								...
								this.Invoke(new MethodInvoker(delegate { cadjpyMoveBox.Text = "(" + move + ")"; }));
								if (moveCalc < hundredMoveShort && cadjpyJustTraded == false)
								{
									sOfferID = "18";
									iAmount = 1000;
									sBuySell = "S";
					...
					if (offerTableRow.Instrument == "CHF/JPY")
					{
						...
						if (chfjpyPast != 0)
						{
							...
							if (chfjpyMove > 0)
							{
								...
								if (moveCalc > fiftyMoveLong && chfjpyJustTraded == false)
								{
									sOfferID = "12";
									iAmount = 1000;
									sBuySell = "B";
							...
							else if (chfjpyMove < 0)
							{
								...
								this.Invoke(new MethodInvoker(delegate { chfjpyMoveBox.Text = "(" + move + ")"; }));
								if (moveCalc < fiftyMoveShort && chfjpyJustTraded == false)
								{
									sOfferID = "12";
									iAmount = 1000;
									sBuySell = "S";
					...
					if (offerTableRow.Instrument == "EUR/AUD")
					{
						...
						if (euraudPast != 0)
						{
							...
							if (euraudMove > 0)
							{
								...
								if (moveCalc > fiftyMoveLong && euraudJustTraded == false)
								{
									sOfferID = "14";
									iAmount = 1000;
									sBuySell = "B";
							...
							else if (euraudMove < 0)
							{
								...
								this.Invoke(new MethodInvoker(delegate { euraudMoveBox.Text = "(" + move + ")"; }));
								if (moveCalc < fiftyMoveShort && euraudJustTraded == false)
								{
									sOfferID = "14";
									iAmount = 1000;
									sBuySell = "S";
					...
					if (offerTableRow.Instrument == "EUR/CAD")
					{
						...
						if (eurcadPast != 0)
						{
							...
							if (eurcadMove > 0)
							{
								...
								if (moveCalc > hundredMoveLong && eurcadJustTraded == false)
								{
									sOfferID = "15";
									iAmount = 1000;
									sBuySell = "B";
							...
							else if (eurcadMove < 0)
							{
								...
								this.Invoke(new MethodInvoker(delegate { eurcadMoveBox.Text = "(" + move + ")"; }));
								if (moveCalc < hundredMoveShort && eurcadJustTraded == false)
								{
									sOfferID = "15";
									iAmount = 1000;
									sBuySell = "S";
					...
					if (offerTableRow.Instrument == "EUR/CHF")
					{
						...
						if (eurchfPast != 0)
						{
							...
							if (eurchfMove > 0)
							{
								...
								if (moveCalc > hundredMoveLong && eurchfJustTraded == false)
								{
									sOfferID = "5";
									iAmount = 1000;
									sBuySell = "B";
							...
							else if (eurchfMove < 0)
							{
								...
								this.Invoke(new MethodInvoker(delegate { eurchfMoveBox.Text = "(" + move + ")"; }));
								if (moveCalc < hundredMoveShort && eurchfJustTraded == false)
								{
									sOfferID = "5";
									iAmount = 1000;
									sBuySell = "S";
					...
					if (offerTableRow.Instrument == "EUR/JPY")
					{
						...
						if (eurjpyPast != 0)
						{
							...
							if (eurjpyMove > 0)
							{
								...
								if (moveCalc > hundredMoveLong && eurjpyJustTraded == false)
								{
									sOfferID = "10";
									iAmount = 1000;
									sBuySell = "B";
							...
							else if (eurjpyMove < 0)
							{
								...
								this.Invoke(new MethodInvoker(delegate { eurjpyMoveBox.Text = "(" + move + ")"; }));
								if (moveCalc < hundredMoveShort && eurjpyJustTraded == false)
								{
									sOfferID = "10";
									iAmount = 1000;
									sBuySell = "S";
					...
					if (offerTableRow.Instrument == "EUR/USD")
					{
						...
						if (eurusdPast != 0)
						{
							...
							if (eurusdMove > 0)
							{
								...
								if (moveCalc > hundredMoveLong && eurusdJustTraded == false)
								{
									sOfferID = "1";
									iAmount = 1000;
									sBuySell = "B";
							...
							else if (eurusdMove < 0)
							{
								...
								this.Invoke(new MethodInvoker(delegate { eurusdMoveBox.Text = "(" + move + ")"; }));
								if (moveCalc < hundredMoveShort && eurusdJustTraded == false)
								{
									sOfferID = "1";
									iAmount = 1000;
									sBuySell = "S";
					...
					if (offerTableRow.Instrument == "GBP/AUD")
					{
						...
						if (gbpaudPast != 0)
						{
							...
							if (gbpaudMove > 0)
							{
								...
								if (moveCalc > hundredMoveLong && gbpaudJustTraded == false)
								{
									sOfferID = "22";
									iAmount = 1000;
									sBuySell = "B";
							...
							else if (gbpaudMove < 0)
							{
								...
								this.Invoke(new MethodInvoker(delegate { gbpaudMoveBox.Text = "(" + move + ")"; }));
								if (moveCalc < hundredMoveShort && gbpaudJustTraded == false)
								{
									sOfferID = "22";
									iAmount = 1000;
									sBuySell = "S";
					...
					if (offerTableRow.Instrument == "GBP/CHF")
					{
						...
						if (gbpchfPast != 0)
						{
							...
							if (gbpchfMove > 0)
							{
								...
								if (moveCalc > hundredMoveLong && gbpchfJustTraded == false)
								{
									sOfferID = "13";
									iAmount = 1000;
									sBuySell = "B";
							...
							else if (gbpchfMove < 0)
							{
								...
								this.Invoke(new MethodInvoker(delegate { gbpchfMoveBox.Text = "(" + move + ")"; }));
								if (moveCalc < hundredMoveShort && gbpchfJustTraded == false)
								{
									sOfferID = "13";
									iAmount = 1000;
									sBuySell = "S";
					...
					if (offerTableRow.Instrument == "GBP/JPY")
					{
						...
						if (gbpjpyPast != 0)
						{
							...
							if (gbpjpyMove > 0)
							{
								...
								if (moveCalc > hundredMoveLong && gbpjpyJustTraded == false)
								{
									sOfferID = "11";
									iAmount = 1000;
									sBuySell = "B";
							...
							else if (gbpjpyMove < 0)
							{
								...
								this.Invoke(new MethodInvoker(delegate { gbpjpyMoveBox.Text = "(" + move + ")"; }));
								if (moveCalc < hundredMoveShort && gbpjpyJustTraded == false)
								{
									sOfferID = "11";
									iAmount = 1000;
									sBuySell = "S";
					...
					if (offerTableRow.Instrument == "GBP/NZD")
					{
						...
						if (gbpnzdPast != 0)
						{
							...
							if (gbpnzdMove > 0)
							{
								...
								if (moveCalc > hundredMoveLong && gbpnzdJustTraded == false)
								{
									sOfferID = "21";
									iAmount = 1000;
									sBuySell = "B";
							...
							else if (gbpnzdMove < 0 && gbpnzdJustTraded == false)
							{
					...
					if (offerTableRow.Instrument == "GBP/USD")
					{
						...
						if (gbpusdPast != 0)
						{
							...
							if (gbpusdMove > 0)
							{
								...
								if (moveCalc > hundredMoveLong && gbpusdJustTraded == false)
								{
									sOfferID = "3";
									iAmount = 1000;
									sBuySell = "B";
							...
							else if (gbpusdMove < 0)
							{
								...
								this.Invoke(new MethodInvoker(delegate { gbpusdMoveBox.Text = "(" + move + ")"; }));
								if (moveCalc < hundredMoveShort && gbpusdJustTraded == false)
								{
									sOfferID = "3";
									iAmount = 1000;
									sBuySell = "S";
					...
					if (offerTableRow.Instrument == "NZD/JPY")
					{
						...
						if (nzdjpyPast != 0)
						{
							...
							if (nzdjpyMove > 0)
							{
								...
								if (moveCalc > fiftyMoveLong && nzdjpyJustTraded == false)
								{
									sOfferID = "19";
									iAmount = 1000;
									sBuySell = "B";
							...
							else if (nzdjpyMove < 0)
							{
								...
								this.Invoke(new MethodInvoker(delegate { nzdjpyMoveBox.Text = "(" + move + ")"; }));
								if (moveCalc < fiftyMoveShort && nzdjpyJustTraded == false)
								{
									sOfferID = "19";
									iAmount = 1000;
									sBuySell = "S";
					...
					if (offerTableRow.Instrument == "NZD/USD")
					{
						...
						if (nzdusdPast != 0)
						{
							...
							if (nzdusdMove > 0)
							{
								...
								if (moveCalc > hundredMoveLong && nzdusdJustTraded == false)
								{
									sOfferID = "8";
									iAmount = 1000;
									sBuySell = "B";
							...
							else if (nzdusdMove < 0)
							{
								...
								this.Invoke(new MethodInvoker(delegate { nzdusdMoveBox.Text = "(" + move + ")"; }));
								if (moveCalc < hundredMoveShort && nzdusdJustTraded == false)
								{
									sOfferID = "8";
									iAmount = 1000;
									sBuySell = "S";
					...
					if (offerTableRow.Instrument == "USD/CAD")
					{
						...
						if (usdcadPast != 0)
						{
							...
							if (usdcadMove > 0)
							{
								...
								if (moveCalc > hundredMoveLong && usdcadJustTraded == false)
								{
									sOfferID = "7";
									iAmount = 1000;
									sBuySell = "B";
							...
							else if (usdcadMove < 0)
							{
								...
								this.Invoke(new MethodInvoker(delegate { usdcadMoveBox.Text = "(" + move + ")"; }));
								if (moveCalc < hundredMoveShort && usdcadJustTraded == false)
								{
									sOfferID = "7";
									iAmount = 1000;
									sBuySell = "S";
					...
					if (offerTableRow.Instrument == "USD/CHF")
					{
						...
						if (usdchfPast != 0)
						{
							...
							if (usdchfMove > 0)
							{
								...
								if (moveCalc > hundredMoveLong && usdchfJustTraded == false)
								{
									sOfferID = "4";
									iAmount = 1000;
									sBuySell = "B";
							...
							else if (usdchfMove < 0)
							{
								...
								this.Invoke(new MethodInvoker(delegate { usdchfMoveBox.Text = "(" + move + ")"; }));
								if (moveCalc < hundredMoveShort && usdchfJustTraded == false)
								{
									sOfferID = "4";
									iAmount = 1000;
									sBuySell = "S";
					...
					if (offerTableRow.Instrument == "USD/JPY")
					{
						...
						if (usdjpyPast != 0)
						{
							...
							if (usdjpyMove > 0)
							{
								...
								if (moveCalc > hundredMoveLong && usdjpyJustTraded == false)
								{
									sOfferID = "2";
									iAmount = 1000;
									sBuySell = "B";
							...
							else if (usdjpyMove < 0)
							{
								...
								this.Invoke(new MethodInvoker(delegate { usdjpyMoveBox.Text = "(" + move + ")"; }));
								if (moveCalc < hundredMoveShort && usdjpyJustTraded == false)
								{
									sOfferID = "2";
									iAmount = 1000;
									sBuySell = "S";
