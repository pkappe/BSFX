...
//|              for the New Zealand Dollar/U.S. Dollar              |
//+------------------------------------------------------------------+
   ...
   if(Symbol()=="NZDUSD" && justTraded==false)
     {
      ...
      if(nzdusdMove>=Move && spread<=MaxSpread && justTraded==false)
        {
      ...
      if(nzdusdMove<=(Move*-1) && spread<MaxSpread && justTraded==false)
        {
         double shortStop=nzdusdAsk+StopLoss;
         double shortGoal=Goal-nzdusdAsk;
