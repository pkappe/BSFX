   ...
   if(Symbol()=="EURCHF" && justTraded==false)
     {
      ...
      if(eurchfMove>=Move && spread<=MaxSpread && justTraded==false)
        {
      ...
      if(eurchfMove<=(Move*-1) && spread<MaxSpread && justTraded==false)
        {
         double shortStop=eurchfAsk+StopLoss;
         double shortGoal=Goal-eurchfAsk;
