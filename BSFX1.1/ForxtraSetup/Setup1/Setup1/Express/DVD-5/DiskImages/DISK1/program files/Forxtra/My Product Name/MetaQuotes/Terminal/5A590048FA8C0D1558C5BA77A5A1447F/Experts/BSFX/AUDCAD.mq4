...
//|             for the Australian Dollar/Canadian Dollar            |
//+------------------------------------------------------------------+
   ...
   if(Symbol()=="AUDCAD" && justTraded==false)
     {
      ...
      if(audcadMove>=Move && spread<=MaxSpread && justTraded==false)
        {
      ...
      if(audcadMove<=(Move*-1) && spread<MaxSpread && justTraded==false)
        {
         double shortStop=audcadAsk+StopLoss;
         double shortGoal=Goal-audcadAsk;
