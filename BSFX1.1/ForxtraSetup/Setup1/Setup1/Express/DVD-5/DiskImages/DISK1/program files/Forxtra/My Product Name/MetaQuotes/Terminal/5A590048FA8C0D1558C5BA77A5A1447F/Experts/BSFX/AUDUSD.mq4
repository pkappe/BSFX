...
//|                for the Australian Dollar/U.S. Dollar           |
//+------------------------------------------------------------------+
   ...
   if(Symbol()=="AUDUSD" && justTraded==false)
     {
      ...
      if(audusdMove>=Move && spread<=MaxSpread && justTraded==false)
        {
      ...
      if(audusdMove<=(Move*-1) && spread<MaxSpread && justTraded==false)
        {
         double shortStop=audusdAsk+StopLoss;
         double shortGoal=Goal-audusdAsk;
