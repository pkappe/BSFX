...
//|                  for the Euro/New Zealand Dollar                 |
//+------------------------------------------------------------------+
   ...
   if(Symbol()=="EURNZD" && justTraded==false)
     {
      ...
      if(eurnzdMove>=Move && spread<=MaxSpread && justTraded==false)
        {
      ...
      if(eurnzdMove<=(Move*-1) && spread<MaxSpread && justTraded==false)
        {
         double shortStop=eurnzdAsk+StopLoss;
         double shortGoal=Goal-eurnzdAsk;
