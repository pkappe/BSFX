...
//|              for the Great Britain Pound/Swiss Franc             |
//+------------------------------------------------------------------+
   ...
   if(Symbol()=="GBPCHF" && justTraded==false)
     {
      ...
      if(gbpchfMove>=Move && spread<=MaxSpread && justTraded==false)
        {
      ...
      if(gbpchfMove<=(Move*-1) && spread<MaxSpread && justTraded==false)
        {
         double shortStop=gbpchfAsk+StopLoss;
         double shortGoal=Goal-gbpchfAsk;
