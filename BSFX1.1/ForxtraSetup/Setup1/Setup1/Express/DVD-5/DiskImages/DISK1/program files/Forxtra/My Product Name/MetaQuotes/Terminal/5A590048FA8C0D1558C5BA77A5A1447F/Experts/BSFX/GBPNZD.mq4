...
//|            for the Great Britain Pound/New Zealand Dollar        |
//+------------------------------------------------------------------+
   ...
   if(Symbol()=="GBPNZD" && justTraded==false)
     {
      ...
      if(gbpnzdMove>=Move && spread<=MaxSpread && justTraded==false)
        {
      ...
      if(gbpnzdMove<=(Move*-1) && spread<MaxSpread && justTraded==false)
        {
         double shortStop=gbpnzdAsk+StopLoss;
         double shortGoal=Goal-gbpnzdAsk;
