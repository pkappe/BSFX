...
//|             for the Australian Dollar/New Zealand Dollar         |
//+------------------------------------------------------------------+
   ...
   if(Symbol()=="AUDNZD" && justTraded==false)
     {
      ...
      if(audnzdMove>=Move && spread<=MaxSpread && justTraded==false)
        {
      ...
      if(audnzdMove<=(Move*-1) && spread<MaxSpread && justTraded==false)
        {
         double shortStop=audnzdAsk+StopLoss;
         double shortGoal=Goal-audnzdAsk;
