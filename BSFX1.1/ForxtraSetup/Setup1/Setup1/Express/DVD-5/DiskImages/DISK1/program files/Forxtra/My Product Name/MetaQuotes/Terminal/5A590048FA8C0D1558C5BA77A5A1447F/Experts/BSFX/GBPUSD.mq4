...
//|              for the Great Britain Pound/U.S. Dollar             |
//+------------------------------------------------------------------+
   ...
   if(Symbol()=="GBPUSD" && justTraded==false)
     {
      ...
      if(gbpusdMove>=Move && spread<=MaxSpread && justTraded==false)
        {
      ...
      if(gbpusdMove<=(Move*-1) && spread<MaxSpread && justTraded==false)
        {
         double shortStop=gbpusdAsk+StopLoss;
         double shortGoal=Goal-gbpusdAsk;
