...
//|                  for the Euro/Australian Dollar                  |
//+------------------------------------------------------------------+
   ...
   if(Symbol()=="EURAUD" && justTraded==false)
     {
      ...
      if(euraudMove>=Move && spread<=MaxSpread && justTraded==false)
        {
      ...
      if(euraudMove<=(Move*-1) && spread<MaxSpread && justTraded==false)
        {
         double shortStop=euraudAsk+StopLoss;
         double shortGoal=Goal-euraudAsk;
