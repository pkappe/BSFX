   ...
   if(Symbol()=="EURUSD" && justTraded==false)
     {
      ...
      if(eurusdMove>=Move && spread<=MaxSpread && justTraded==false)
        {
      ...
      if(eurusdMove<=(Move*-1) && spread<MaxSpread && justTraded==false)
        {
         double shortStop=eurusdAsk+StopLoss;
         double shortGoal=Goal-eurusdAsk;
