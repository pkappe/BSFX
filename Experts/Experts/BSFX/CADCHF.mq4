   ...
   if(Symbol()=="CADCHF" && justTraded==false)
     {
      ...
      if(cadchfMove>=Move && spread<=MaxSpread && justTraded==false)
        {
      ...
      if(cadchfMove<=(Move*-1) && spread<MaxSpread && justTraded==false)
        {
         double shortStop=cadchfAsk+StopLoss;
         double shortGoal=Goal-cadchfAsk;
