...
//|              for the United States Dollar/Canadian Dollar        |
//+------------------------------------------------------------------+
   ...
   if(Symbol()=="USDCAD" && justTraded==false)
     {
      ...
      if(usdcadMove>=Move && spread<=MaxSpread && justTraded==false)
        {
      ...
      if(usdcadMove<=(Move*-1) && spread<MaxSpread && justTraded==false)
        {
         double shortStop=usdcadAsk+StopLoss;
         double shortGoal=Goal-usdcadAsk;
